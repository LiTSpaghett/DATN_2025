...
//   try {
//     await axios.delete(
//       `http://localhost:5000/api/admin/auth/${id}`,  // kiểm tra route mount chuẩn
//       {
//         headers: {
//           Authorization: `Bearer ${localStorage.getItem("token")}`, // chữ A hoa
//         },
//       }
//     );
...
//           <td className="p-2 border">{user.isAdmin ? "Admin" : "Khách hàng"}</td>
//           <button 
